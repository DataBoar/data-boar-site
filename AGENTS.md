...
- **Primary non-tech onboarding:** `windows.html` + `data-boar --demo` (synthetic). Business-intent SEO pages: `inventario-dados-pessoais-lgpd.html`, `descobrir-dados-pessoais.html`, `data-discovery-contabilidade.html`, `faq.html`, case `casos/menores-lgpd-art-14.html` — answer-first, link to Windows/demo, no legal overclaim.
